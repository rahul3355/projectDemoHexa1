...
const AddEmp = () => {
    ...
    return (
        <div>
            ...
            <br />
                <h4 id="info2">ADD LEAVE REQUEST</h4>
                <br />
                <div class="container">
                ...
                <input type="number" id="leavesInHand" onChange={handleChange} min="0" max="30" required></input><br></br><br /> */}
                        ...
                        <input type="date" id="leaveStart" onChange={handleChange} min="2022-09-15" required></input><br /><br />
                ...
                <input type="text" id="leaveType" onChange={handleChange}></input><br/> */}
                        <div class="container-sm cm row">
                            <label class="col-2">Leave Type</label>
                            <select class="custom-select dropd col-5" type="text" name="brad" id="leaveType" onChange={handleChange}>
